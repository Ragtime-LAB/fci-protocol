...
using ArmControlSession = StreamSession<
    ...
    fci::arm::AckPacket,
    fci::arm::SetMitLimitRequestPacket,
    fci::arm::SetMitLimitResponsePacket,
    ...
    fci::arm::RunCalibrationRequestPacket,
    fci::arm::RunCalibrationResponsePacket,
    fci::arm::ClearFaultsRequestPacket,
    fci::arm::ClearFaultsResponsePacket,
    fci::arm::SetSafetyRequestPacket,
    fci::arm::SetSafetyResponsePacket,
